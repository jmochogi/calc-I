...
-   ***Housing:*** Look up the cost of rent in the area you are considering. You will need to decide if you will have roommates or live alone. You will also need to consider utilities, internet, and renter's insurance, etc. You can find an apartment to rent via an online advertisement. Print a picture of the place along with the particulars.
...
You will be required to submit a final report including the following: - an explanation of your employment plans---include why you want the job, what training is required for it, and project how much money you will earn each month from the starting pay. Your salary should be realistic for the job you are considering.
