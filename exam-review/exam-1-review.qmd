...
The piecewise-defined function below represents the shipping charges, $C(x)$, for packages based on the package weight, $x$ (in pounds).
...
a.  Estimate the value of $f(20)$ and state its meaning in context. \vspace{4cm}
b.  Without doing any calculations, state whether you expect $f(25)$ to be greater or less than $f(30)$. Explain how you know. \newpage
c.  Without doing any calculations, state whether you expect the average rate of change between $t=15$ and $t=25$ to be greater or less than the average rate of change between $t=40$ and $t=80.$ Explain how you know. \vspace{4cm}
